...
/**
 * Integration test that verifies the ability of the SJMS Consumer to utilize a
 * {@link DestinationResolver}
 */
public class DestinationResolverConsumerTest extends JmsTestSupport {

    @EndpointInject(uri = "sjms:queue:test.invalid.queue")
    ...
    @Test
    public void destinationResolverConsumerTest() throws InterruptedException {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                from("sjms:queue:test.invalid.queue").to("mock:result");
